...
<em>This message was sent by {site_link} on {current_time}.</em>',
	...
	public function load_settings_panel() {
		...
		$sap = sap_initialize_library(
			array(
				'version'		=> '2.6.3', // Version of the library
	...
	public function premium_info( $section_and_perm_type ) {
		...
		$premium_features = '
			<p><strong>' . __( 'The premium version also gives you access to the following features:', 'food-and-drink-menu' ) . '</strong></p>
			<ul class="fdm-dashboard-new-footer-one-benefits">
				<li>' . __( 'Advanced Menu Layouts', 'food-and-drink-menu' ) . '</li>
				<li>' . __( 'Feature-Rich Ordering', 'food-and-drink-menu' ) . '</li>
			...
			<div class="fdm-dashboard-new-footer-one-buttons">
				<a class="fdm-dashboard-new-upgrade-button" href="https://www.fivestarplugins.com/license-payment/?Selected=FDM&Quantity=1" target="_blank">' . __( 'UPGRADE NOW', 'food-and-drink-menu' ) . '</a>
			</div>
		';
		...
		switch ( $section_and_perm_type ) {
			...
			case 'ordering':
				...
				$content = '
					<div class="fdm-settings-preview">
						<h2>' . __( 'Ordering', 'food-and-drink-menu' ) . '<span>' . __( 'Premium', 'food-and-drink-menu' ) . '</span></h2>
						<p>' . __( 'You can allow your customers to place orders directly from your menu. There are options to require payment (PayPal or Stripe), set a minimum amount for ordering, set a schedule for when ordering should be available, configure the associated notifications and more!', 'food-and-drink-menu' ) . '</p>
						<div class="fdm-settings-preview-images">
